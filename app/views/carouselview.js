Lastcowboy.views.carouselViewPanel=Ext.extend(Ext.Panel,{
    scroll:'vertical',
    layout:  {
        type : 'vbox',
        align: 'stretch'
    ...
    initComponent:function() {
        ...
        this.producttitlepanel=new Ext.Panel({
         ...
         this.productdetailspanel=new Ext.Panel({
             ...
             layout:'fit',
             tpl:'<div class="productdetails"><div class="price">{price}</div><div class="cartbtn">Add to cart</div><div>{desc}</div></div>',
             id:'pdetails'
        ...
        Lastcowboy.views.carouselViewPanel.superclass.initComponent.apply(this, arguments);       
